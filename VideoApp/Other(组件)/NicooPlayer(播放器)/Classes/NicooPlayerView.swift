...
//            self.hideLoadingHud()
    ...
    private func addUserActionBlock() {
        ...
        playControllViewEmbed.replayButtonClickBlock = { [weak self] (_) in
			self?.avItem?.seek(to: kCMTimeZero, completionHandler: nil)
        ...
        playControllViewEmbed.pangeustureAction = { [weak self] (sender) in
            ...
            case .changed:
                ...
                case .PanDirectionHorizontal:
					...
					avItem.seek(to: positionValue, toleranceBefore: kCMTimeZero, toleranceAfter: kCMTimeZero, completionHandler: nil)
                    break
            ...
            case .ended:
                ...
                case .PanDirectionHorizontal:
                    ...
                    avItem.seek(to: po, toleranceBefore: kCMTimeZero, toleranceAfter: kCMTimeZero, completionHandler: nil)
